...
# Remove any older bridge integration with the read-only screen synchronizer.
...
if 'self.screen_sync=ScreenSync()' not in s:
    s = s.replace(needle, needle + "        self.screen_sync=ScreenSync(); self.sync_busy=False; self.sync_last=0\n", 1)
